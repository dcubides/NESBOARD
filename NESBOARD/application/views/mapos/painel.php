  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      ...
      <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vTicket')){ ?>
            <li class="bg_lb"> <a href="<?php echo base_url()?>index.php/tickets"> <i class="icon-group"></i> Tickets</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vInventario')){ ?>
            <li class="bg_lg"> <a href="<?php echo base_url()?>index.php/clientes"> <i class="icon-barcode"></i> Inventario</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vModulo3')){ ?>
            <li class="bg_ls"> <a href="<?php echo base_url()?>index.php/produtos"> <i class="icon-barcode"></i> Desarrollo</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vModulo4')){ ?>
            <li class="bg_ly"> <a href="<?php echo base_url()?>index.php/servicos"> <i class="icon-wrench"></i> Desarrollo</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vModulo5')){ ?>
            <li class="bg_lo"> <a href="<?php echo base_url()?>index.php/os"> <i class="icon-tags"></i> Desarrollo</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vModulo6')){ ?>
            <li class="bg_ls"> <a href="<?php echo base_url()?>index.php/vendas"><i class="icon-shopping-cart"></i> Desarrolo</a></li>
        <?php } ?>
...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Tickets Creados</h5></div>
    ...
    <div class="span12" style="margin-left: 0">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Informes</h5></div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                        <tr>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">           
                    <div class="span12">
                        <ul class="site-stats">
                            <li class="bg_lh"><i class="icon-group"></i> <strong><?php echo $this->db->count_all('nesitelco.directorio');?></strong> <small>Usuarios BMRS</small></li>
                            <li class="bg_lh"><i class="icon-barcode"></i> <strong><?php echo $this->db->count_all('controlm.kardex');?></strong> <small>Movimientos </small></li>
                            <li class="bg_lh"><i class="icon-tags"></i> <strong><?php echo $this->db->count_all('nesitelco.ticket');?></strong> <small>Tickets Creados</small></li>
                            <li class="bg_lh"><i class="icon-wrench"></i> <strong><?php echo $this->db->count_all('usuarios');?></strong> <small>Servicios</small></li>

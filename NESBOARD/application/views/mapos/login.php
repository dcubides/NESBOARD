...
<head>
        <title>NESITELCO S.A. LOGIN.</title><meta charset="UTF-8" />
    ...
    <body background="assets/img/saturation.png">
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/mapos/verificarLogin">
                  ...
                  <?php }?>
                <div class="control-group normal_text"> <h3><img src="<?php echo base_url()?>assets/img/nesitellogo.png" alt="Logo" /></h3></div>
        ...
        <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <h4 id="myModalLabel">Nesitelco S.A.</h4>
          </div>
